...
(function (ipu, $) {
     ...
     * @param {String} actions.action.text 操作名称
     * @param {Boolean} actions.action.label 是否标签，非标签就是操作项，操作项有后续的配置，标签项无须后续配置项
     * @param {String:warning} actions.action.color 样式，可选
     * @param {String:warning} actions.action.bg 背景样式，可选
     * @param {Function} actions.action.onClick 点击时回调函数
     */
